...
import MaxPkScoreTable from "./MaxPkScoreTable";
import { Tooltip, TooltipTrigger, TooltipContent } from "@/components/ui/tooltip";

export default function StudentPLOScore({ studentId }) {
  ...
  return (
    <div className="w-full">
      <h1 className="text-2xl font-bold mb-2">
        Điểm chuẩn đầu ra của CTĐT của Sinh Viên
      </h1>
      <div>
        {role !== "Student" && (
        ...
        <div>Di chuột vào từng PLO để xem phát biểu</div>
